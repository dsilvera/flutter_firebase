...
class MessageItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        Row(
            children: <Widget>[message.type == 0 ? messageContainer() : imageContainer()],
            mainAxisAlignment:
        ...
        isLastMessage
            ? Container(
                ...
                margin: EdgeInsets.only(left: 15.0, right: 15, bottom: 5.0),
              )
            : Container()
      ],
      crossAxisAlignment:
  ...
  Widget messageContainer() {
    return Container(
      ...
      margin: EdgeInsets.only(bottom: isLastMessage ? 20.0 : 10.0, right: 10.0, left: 10.0),
    );
  }
